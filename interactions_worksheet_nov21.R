####Interaction/Moderation Regression Worksheet
...
###create mean centered versions of the variables
...
###establish that there is a SIGNIFICANT INTERACTION - is the slope of the product term significant?

##Can also use an equivalent Blocks approach
...
###explore the nature of the interaction (if significant) - continuous variables
## relation b/w anxiety and exam scores at HIGH PREPARATION (simple slope at +1 SD)
...
## relation b/w anxiety and exam scores at LOW PREPARATION (simple slope at -1 SD)
...
#additions 
my.plot <- my.plot+annotate("text", x = -1, y = 68.5, label = "+1 SD Preparation")
my.plot <- my.plot+annotate("text", x = -1, y = 43.5, label = "-1 SD Preparation, Exam = -3.97(Anxiety) + 46.45", angle=-27)
print(my.plot)
